...
func ParseFlags() *Flags {
	...
	flag.StringVar(&flags.SeedSource, "seed-source", "", "Seed data source: synthetic, cohere, or cohere-full (default: synthetic)")
...
func PrintHelp() {
	...
	fmt.Println("  --seed-source string     Seed data source (default: synthetic)")
	fmt.Println("                           - synthetic: Random vectors")
	fmt.Println("                           - cohere: Partial Cohere BEIR corpus")
	fmt.Println("                           - cohere-full: Full 8.8M MS MARCO corpus (enables business recall)")
	...
	fmt.Println()
	fmt.Println("  # Seed database with synthetic data")
	fmt.Println("  zilliz-loadtest --seed --api-key KEY --database-url URL --collection COLL")
	fmt.Println()
	fmt.Println("  # Seed with full MS MARCO corpus (8.8M documents, enables business recall)")
	fmt.Println("  zilliz-loadtest --seed --seed-source cohere-full --api-key KEY --database-url URL --collection COLL")
	fmt.Println()
